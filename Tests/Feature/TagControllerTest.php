...
class TagControllerTest extends TestCase
{
    ...
    {
        $response = $this->get(action('\Gdevilbat\SpardaCMS\Modules\Post\Http\Controllers\TagController@index'));
        ...
        $response = $this->actingAs($user)
                         ->from(action('\Gdevilbat\SpardaCMS\Modules\Post\Http\Controllers\TagController@index'))
                         ->json('GET',action('\Gdevilbat\SpardaCMS\Modules\Post\Http\Controllers\TagController@serviceMaster'))
                         ->assertSuccessful()
    ...
    {
        $response = $this->post(action('\Gdevilbat\SpardaCMS\Modules\Post\Http\Controllers\TagController@store'));
        ...
        $response = $this->actingAs($user)
                         ->from(action('\Gdevilbat\SpardaCMS\Modules\Post\Http\Controllers\TagController@create'))
                         ->post(action('\Gdevilbat\SpardaCMS\Modules\Post\Http\Controllers\TagController@store'))
                         ->assertStatus(302)
                         ->assertRedirect(action('\Gdevilbat\SpardaCMS\Modules\Post\Http\Controllers\TagController@create'))
        ...
        $response = $this->actingAs($user)
                         ...
                         ->assertStatus(302)
                         ->assertRedirect(action('\Gdevilbat\SpardaCMS\Modules\Post\Http\Controllers\TagController@index'))
    ...
    public function testUpdateDataTag()
    {
        ...
        $response = $this->actingAs($user)
                        ->from(action('\Gdevilbat\SpardaCMS\Modules\Post\Http\Controllers\TagController@create').'?code='.encrypt($taxonomy->getKey()))
                        ->post(action('\Gdevilbat\SpardaCMS\Modules\Post\Http\Controllers\TagController@store'), [
    ...
    {
        $response = $this->post(action('\Gdevilbat\SpardaCMS\Modules\Post\Http\Controllers\TagController@destroy'), [
                        '_method' => 'DELETE'
                    ]);
        ...
        $response = $this->actingAs($user)
                        ->from(action('\Gdevilbat\SpardaCMS\Modules\Post\Http\Controllers\TagController@index'))
                        ->post(action('\Gdevilbat\SpardaCMS\Modules\Post\Http\Controllers\TagController@destroy'), [
                            $taxonomy->getKeyName() => encrypt($taxonomy->getKey()),
                            '_method' => 'DELETE'
                        ])
                        ->assertStatus(302)
