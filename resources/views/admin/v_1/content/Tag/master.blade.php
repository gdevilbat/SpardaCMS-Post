    ...
    <div class="col-sm-12">
        ...
        <div class="m-portlet m-portlet--tab">
            ...
            <div class="m-portlet__body">
                ...
                <!--begin: Datatable -->
                <table class="table table-striped data-table-ajax" id="data-taxonomy" data-ajax="{{action('\Gdevilbat\SpardaCMS\Modules\Post\Http\Controllers\TagController@serviceMaster')}}" width="100%">
                    <thead>
                        <tr>
                            <th>ID</th>
