        ...
        <div class="m-portlet m-portlet--tab">
            ...
            <div class="m-portlet__body">
                ...
                @can('create-taxonomy')
                    <div class="row mb-4">
                        <div class="col-md-5">
                            <a href="{{route('cms.post-tag.create')}}" class="btn btn-brand m-btn m-btn--custom m-btn--icon m-btn--pill m-btn--air">
                                <span>
                ...
                <!--begin: Datatable -->
                <table class="table table-striped data-table-ajax" id="data-taxonomy" data-ajax="{{route('cms.post-tag.service-master')}}" width="100%">
                    <thead>
                        <tr>
                            <th>ID</th>
